...
export const SEED_FORM_SECTIONS = [
    ...
    /* ───────── single-session: 1對1線上課程_1堂 (duplicate of 6 sections) ───────── */
    {
        ...
        en_title: 'About you',
        description: '請填寫你的基本資訊',
        en_description: 'Just a few details about you',
        sort_order: 1,
        fields: [
            {
                id: 'ss-f-name',
            ...
            },
            {
                ...
                field_type: 'text',
                label: 'IG 名稱',
                en_label: 'Your name on Instagram',
                placeholder: '你的 Instagram 帳號',
    ...
    },
    {
        ...
        description: '告訴我們你的毛孩',
        en_description: 'Tell us about your furry family member',
        sort_order: 2,
        fields: [
            {
                id: 'ss-f-dog-name',
                ...
                placeholder: '你的狗狗叫什麼名字？',
                en_placeholder: 'e.g. Buddy or Mochi',
                description: null,
                en_description: null,
                is_required: true,
                sort_order: 1,
            ...
            },
            {
                ...
                placeholder: '什麼時候加入你的家庭？從哪裡來的？（收容所、繁殖場、朋友等）',
                en_placeholder: 'e.g. March 2022, rescue shelter',
                description: null,
                en_description: null,
                is_required: true,
                sort_order: 5,
            ...
            },
            {
                ...
                placeholder: '誰是主要照顧狗狗的人？',
                en_placeholder: 'e.g. Me, or me and my partner',
                description: null,
                en_description: null,
                is_required: true,
                sort_order: 6,
    ...
    },
    {
        ...
        service_id: 'single-session',
        title: '日常生活',
        en_title: 'Daily routine',
        description: '了解狗狗的日常作息',
        en_description: "Help us understand your dog's daily routine",
        sort_order: 3,
        fields: [
            {
                id: 'ss-f-walk-freq',
                ...
                placeholder: '例如：一天 2 次，每次 30 分鐘',
                en_placeholder: 'e.g. 2 walks/day, about 30 mins each',
                description: null,
                en_description: null,
                is_required: true,
                sort_order: 1,
            ...
            },
            {
                ...
                placeholder: '通常在哪裡散步？',
                en_placeholder: 'e.g. nearby park, neighbourhood streets',
                description: null,
                en_description: null,
                is_required: true,
                sort_order: 2,
            ...
            },
            {
                ...
                placeholder: '描述狗狗在家裡的活動空間',
                en_placeholder: 'e.g. small apartment, house with a yard',
                description: null,
                en_description: null,
                is_required: true,
                sort_order: 3,
    ...
    },
    {
        ...
        description: '這是最重要的部分，請盡量詳細描述',
        en_description: 'The most important section — please be as detailed as you can',
        sort_order: 4,
        fields: [
            {
                id: 'ss-f-main-issue',
                ...
                placeholder: '請描述你最希望改善的狗狗行為問題',
                en_placeholder: "Describe the behaviour(s) you most want to improve",
                description: null,
            ...
            },
            {
                ...
                placeholder: '你目前嘗試過哪些方式來解決這個問題？',
                en_placeholder: 'e.g. training classes, online videos, redirecting with treats',
                description: null,
                en_description: null,
                is_required: true,
                sort_order: 2,
            ...
            },
            {
                ...
                placeholder: '之前有找過其他訓犬師嗎？效果如何？',
                en_placeholder: 'e.g. Yes, tried group classes — some progress but issues remain',
                description: null,
                en_description: null,
                is_required: true,
                sort_order: 3,
            ...
            },
            {
                ...
                placeholder: '狗狗是否有咬人或咬狗的紀錄？請描述情況',
                en_placeholder: 'e.g. Snapped once but never broke skin',
                description: null,
                en_description: null,
                is_required: true,
                sort_order: 4,
            ...
            },
            {
                ...
                placeholder: '什麼情境讓你的狗狗壓力最大？',
                en_placeholder: 'e.g. Passing other dogs, visitors at the door, loud noises',
                description: null,
                en_description: null,
                is_required: true,
                sort_order: 5,
            ...
            },
            {
                ...
                placeholder: '在那個情境中，狗狗會有什麼行為反應？',
                en_placeholder: 'e.g. Lunges and barks, tries to hide, freezes on the spot',
                description: null,
                en_description: null,
                is_required: true,
                sort_order: 6,
            ...
            },
            {
                ...
                placeholder: '你希望狗狗能有什麼樣的改變？',
                en_placeholder: 'e.g. Walk calmly past other dogs, stop jumping on guests',
                description: null,
                en_description: null,
                is_required: true,
                sort_order: 7,
            ...
            },
            {
                ...
                placeholder: '你在訓練狗狗時遇到的最大困難是什麼？',
                en_placeholder: "e.g. Staying consistent, reading my dog's body language",
                description: null,
                en_description: null,
                is_required: true,
                sort_order: 8,
    ...
    },
    {
        ...
        service_id: 'single-session',
        title: '健康狀況',
        en_title: 'Health & wellbeing',
        description: '了解狗狗的身體狀況',
        en_description: 'Tell us about any current or past health conditions',
        sort_order: 5,
        fields: [
            {
                id: 'ss-f-health',
                ...
                en_placeholder: null,
                description: '請勾選狗狗目前或曾經有的身體狀況',
                en_description: "Select all that apply to your dog's current or past health.",
                is_required: true,
                sort_order: 1,
                options: [
                    { value: 'arthritis', label: '關節炎' },
                ...
                en_options: [
                    ...
                    { value: 'pancreatitis', label: 'Pancreatitis / digestive issues' },
                    { value: 'skin-allergy', label: 'Skin allergies' },
    ...
    },
    {
        ...
        description: '最後的補充資訊',
        en_description: 'Almost done — just your contact details',
        sort_order: 6,
        fields: [
            {
                id: 'ss-f-other',
                ...
                placeholder: '有沒有其他想讓我們知道的事情？',
                en_placeholder: 'Anything else we should know about your dog or your situation',
                description: null,
                en_description: null,
                is_required: false,
                sort_order: 1,
            ...
            },
            {
                ...
                placeholder: '0912-345-678',
                en_placeholder: '+60 12-345 6789 (or your local format)',
                description: null,
                en_description: null,
                is_required: true,
                sort_order: 3,
